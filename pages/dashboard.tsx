        ...
        <div className={styles.main__wrapper}>
            <div className={styles.main__left__wrapper}>
                <div className={styles.top__card__wrapper}>
                    <TopCards color="#FFEFE7" content="346" header="AY 2023 UG" footer="346 students registered"/>
                    <TopCards color="#E8F0FB" content="107" header="AY 2023 PG" footer="107 students registered"/>
                    <TopCards color="#FDEBF9" content="24" header="AY 2023 DIPLOMA" footer="24 students registered"/>
                </div>
                    ...
                    <div className={styles.frequency__inner__wrapper}>
                        <div className={styles.frequency__header}>
                            ...
                            <div style={{width: '50%', marginTop: 5}}>
                                <CustomInput type="drop-down" data={formResData} placeholder={"Form Name"} label={""}/>
                            </div>
                        </div>
